...
server.registerTool(
  "arch_ceiling_create",
  {
    ...
    description:
      "Crea un plafón por contorno en un nivel (Revit 2022+).",
    inputSchema: CeilingCreateShape,
  },
  async (args: z.infer<typeof CeilingCreateSchema>) => {
...
server.registerTool(
  "arch_ceilings_from_rooms",
  {
    ...
    description:
      "Crea plafones a partir de habitaciones (Revit 2022+).",
...
server.registerTool(
  ...
  async (args: z.infer<typeof FamilyLoadSchema>) => {
...
server.registerTool(
  "arch_family_place",
  {
    ...
    description:
      "Coloca una instancia de familia no-hosted (p.ej. Generic Model). Para hosteadas usa herramientas específicas (puertas/ventanas).",
    inputSchema: FamilyPlaceShape,
  },
  async (args: z.infer<typeof FamilyPlaceSchema>) => {
...
server.registerTool(
  ...
  async (args: z.infer<typeof RailingCreateSchema>) => {
...
server.registerTool(
  ...
  async (args: z.infer<typeof StairCreateSchema>) => {
...
server.registerTool(
  ...
  async (args: z.infer<typeof RampCreateSchema>) => {
