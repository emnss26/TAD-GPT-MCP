...
server.registerTool("mep_duct_connect", {
    title: "Connect Ducts/Elements",
    description: "Conecta dos elementos MEP (ductos o familias con conectores). mode: auto | elbow | transition.",
...
server.registerTool("mep_duct_add_insulation", {
    title: "Add Duct Insulation (Bulk)",
    description: "Agrega aislamiento a ductos; typeName opcional; thickness_mm opcional.",
...
server.registerTool("mep_duct_add_lining", {
    title: "Add Duct Lining (Bulk)",
    description: "Agrega recubrimiento interno (lining) a ductos; typeName/thickness_mm opcionales.",
...
server.registerTool("mep_duct_set_offset", {
...
server.registerTool("mep_pipe_connect", {
    title: "Connect Pipes/Elements",
    description: "Conecta dos elementos (pipes o familias con conectores). mode: auto | elbow | transition.",
...
server.registerTool("mep_pipe_add_insulation", {
    title: "Add Pipe Insulation (Bulk)",
    description: "Agrega aislamiento a pipes; typeName opcional; thickness_mm opcional.",
...
server.registerTool("mep_pipe_set_offset", {
...
server.registerTool("mep_conduit_set_offset", {
...
server.registerTool("mep_conduit_set_diameter", {
...
server.registerTool("mep_cabletray_set_size", {
...
server.registerTool("mep_cabletray_set_offset", {
