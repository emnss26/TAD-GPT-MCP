...
server.registerTool("struct_foundation_isolated_create", {
...
server.registerTool("struct_foundation_wall_create", {
...
server.registerTool("struct_beamsystem_create", {
...
server.registerTool("struct_rebar_add_straight_on_beam", {
