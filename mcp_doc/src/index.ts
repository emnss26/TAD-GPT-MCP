...
server.registerTool(
  "doc_sheets_create",
  {
    title: "Create Sheet",
    description:
      "Crea una lámina con número/nombre opcional y un type de carátula (titleblock) opcional.",
...
server.registerTool(
  "doc_sheets_create_bulk",
  {
    title: "Create Sheets (Bulk)",
    description:
      "Crea múltiples láminas en lote. Evita duplicados por número de lámina.",
...
server.registerTool(
  "doc_sheets_add_views",
  {
    title: "Add Views to Sheet",
    description:
      "Agrega vistas a una lámina. Puedes referenciar la lámina por Id o nombre/número; y las vistas por Id o nombre.",
...
server.registerTool(
  "doc_sheets_assign_revisions",
  {
    title: "Assign Revision to Sheets",
    description:
      "Crea/actualiza una revisión (por descripción/fecha) y la asigna a láminas objetivo.",
...
server.registerTool(
  "doc_views_set_scope_box",
  {
    title: "Set Scope Box on Views",
    description:
      "Asigna una scope box (por nombre) a un conjunto de vistas, y opcionalmente activa el crop.",
...
server.registerTool(
  "doc_sheets_add_schedules",
  {
    title: "Add Schedules to Sheet",
    description:
      "Coloca tablas (ViewSchedules) en una lámina por Id/nombre. Layout en grid opcional.",
...
server.registerTool(
  "doc_sheets_set_params_bulk",
  {
    title: "Set Sheet Parameters (Bulk)",
    description:
      "Asigna valores a parámetros de múltiples láminas por Id/nombre. Soporta String, Double, Integer/YesNo.",
