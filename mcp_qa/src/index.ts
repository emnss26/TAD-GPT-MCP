...
server.registerTool(
  "qa_apply_view_templates",
  {
    title: "Apply view template to views",
    description:
      "Aplica una plantilla a vistas. Si no se especifica plantilla y hay varias, devuelve la lista de opciones.",
...
server.registerTool(
  "qa_unhide_all_in_view",
  {
    title: "Unhide all in view",
    description:
      "Desoculta elementos/categorías y limpia Temporary Hide/Isolate en la vista activa o indicada.",
...
/* =========================================
   ...
   ========================================= */
server.registerTool(
  "qa_delete_unused_view_templates",
  {
    title: "Delete unused view templates",
    description:
      "Elimina plantillas de vista no referenciadas por ninguna vista.",
    inputSchema: NoArgs,
  },
...
/* =========================================
   ...
   ========================================= */
server.registerTool(
  "qa_delete_unused_view_filters",
  {
    title: "Delete unused view filters",
    description:
      "Elimina filtros (ParameterFilterElement) no usados por ninguna vista/plantilla.",
    inputSchema: NoArgs,
  },
